...
class medoo
{
	...
	/*
	protected $server = 'sql18.c.artfiles.de';
	protected $username = 'db171290002';
	protected $password = 'a5w4km03sf';
    protected $database_name = 'db171290002';
     */
     
    protected $server = 'web2';
    protected $username = 'root';
    protected $password = '';
    protected $database_name = 'pcs2';
